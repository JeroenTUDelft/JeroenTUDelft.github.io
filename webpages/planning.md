...
1. Lobby: 100m2 
2. Carpark: 4000m2 
3. Grocery Store: 300m2
4. Bicycle Storage: 250m2
5. Communal Library/Coffee Corner: 600m2
6. Care Centre: 153m2
7. Shared Kitchen/Living Room (floor-shared): 5000m2
8. Laundry Room (floor-shared): 200m2
9. Self-Contained Starter Unit Loft: 5500m2 
   - Living room/kitchen
   - Bedroom
   - Bathroom
   - Balcony 
10. Self-Contained Starter Unit (single-level): 7000m2 
    - Living room/kitchen
    - Bedroom
    - Bathroom
    - Balcony 
11. Self-Contained Student Unit (<25m2): 5600m2
    - Studio
    - Bathroom
    - Balcony
12. Shared-Living Student Unit: 6200m2
    - Living Room/Kitchen
    - Bathroom
    - Balcony
    - Bedroom (n) (<25m2) 
13. Self-Contained Elderly Unit: 7200m2
    - Studio
    - Bathroom
    - Balcony
14. Assisted-Living Elderly Unit: 5400m2
    - Living Room/Kitchen
    - Bathroom
    - Balcony
    - Bedroom (n) 
15. Roof Garden 
16. Solar Panels 
17. Storage Unit : 4500m2
18. Technical Storage : 20m2
19. Rainwater Tank 
...
In the table below the relation between every user group and every function is displayed. The higher the number listed, the more important we recon the relation to be for that specific user. The relations are listed between 0 and 1 with 0 meaning the function is not important to the user and 1 meaning the function is absolutely necessary.
